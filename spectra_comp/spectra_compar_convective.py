...
line_cols = [line_cols[-2],line_cols[0],line_cols[1],line_cols[7],line_cols[5],line_cols[8],line_cols[2],line_cols[7],line_cols[3],line_cols[6]]
...
file_list = ['c_003_001.mat','c_003_002.mat','c_003_011.mat','c_003_007.mat']#,'c_003_020.mat','c_003_014.mat']
...
plt.yticks([1e-10,1e-9,1e-8,1e-7])
plt.gca().set_xlim([4e-4,6e-2])
