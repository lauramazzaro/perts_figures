...
plt.text(0.5,0.5,'25000 m',color=cols[5],transform=plt.gca().transAxes,fontsize=18)
plt.text(0.5,0.4,'30000 m',color=cols[6],transform=plt.gca().transAxes,fontsize=18)
plt.text(0.5,0.3,'35000 m',color=cols[7],transform=plt.gca().transAxes,fontsize=18)
plt.text(0.5,0.2,'40000 m',color=cols[8],transform=plt.gca().transAxes,fontsize=18)
plt.text(0.5,0.1,'45000 m',color=cols[9],transform=plt.gca().transAxes,fontsize=18)
...
plt.savefig('../theta_heights.png',dpi=600)
