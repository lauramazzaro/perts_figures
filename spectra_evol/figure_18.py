...
plt.text(0.2,0.45,'250 m',color=cols[0],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.2,0.35,'1250 m',color=cols[1],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.2,0.25,'2500 m',color=cols[2],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.2,0.15,'3750 m',color=cols[3],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.2,0.05,'5000 m',color=cols[4],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.5,0.45,'10000 m',color=cols[5],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.5,0.35,'15000 m',color=cols[6],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.5,0.25,'20000 m',color=cols[7],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.5,0.15,'30000 m',color=cols[8],transform=plt.gca().transAxes,fontsize=15)
plt.text(0.5,0.05,'40000 m',color=cols[9],transform=plt.gca().transAxes,fontsize=15)
...
plt.savefig('../figure_18.png',dpi=600)
